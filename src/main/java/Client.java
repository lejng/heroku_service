...
public class Client {
    static final String URL_LOGIN = "https://service228.herokuapp.com/login";
    static final String URL_EMPLOYEES = "https://service228.herokuapp.com/account";
    ...
    private static String postLogin(String username, String password) {
        ...
        parametersMap.add("phone", username);
